...
PUBLIC int do_set_process_priority()
{
	message msg = mm_in;
	return _taskcall(SYSTASK, SYS_SET_PROCESS_PRIORITY, &msg);
}
PUBLIC int do_get_process_priority()
{
	message msg = mm_in;
	return _taskcall(SYSTASK, SYS_GET_PROCESS_PRIORITY, &msg);
}

PUBLIC int do_get_process_counter()
{
	message msg = mm_in;
	return _taskcall(SYSTASK, SYS_GET_PROCESS_COUNTER, &msg);
}
